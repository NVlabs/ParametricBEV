...
class DeformableDETRHead3DDebug2(DETRHead):
    ...
    def loss(self,
        ...
        '''
        losses_cls, losses_bbox_l1 = multi_apply(
        ...
        num_dec_layer = 0
        for loss_cls_i, loss_bbox_l1_i in zip(losses_cls[:-1],
                                                       losses_bbox_l1[:-1]):
    ...
    def loss_single(self,
        ...
        loss_bbox = self.loss_bbox(bbox_preds*bbox_weights,
